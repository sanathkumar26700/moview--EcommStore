  ...
  return (
    <section className="login__container">
            <div className="login__container--box">
                <img className="bg--image" src="https://moview-store.netlify.app/images/Compact_disc.svg.png" alt="compact-disk-bg"/>
                ...
                <p className={errMsg ? "errMsg" : "offscreen"}>{errMsg}</p>
                    <form className="input__container">
                        ...
                        <button 
                            type="submit"
                            onClick={(e) => handleSubmit(e,'tonystark@starkinudustries.in','Mark@123')}
                            className="main--btn btn btn__primary btn__primary--animated">
                            Login as guest
                        </button>
                    </form>
